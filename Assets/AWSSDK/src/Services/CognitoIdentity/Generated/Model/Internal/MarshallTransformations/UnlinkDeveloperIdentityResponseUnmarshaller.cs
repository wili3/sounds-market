...
namespace Amazon.CognitoIdentity.Model.Internal.MarshallTransformations
{
    ...
    /// </summary>  
    public class UnlinkDeveloperIdentityResponseUnmarshaller : JsonResponseUnmarshaller, ISimplifiedErrorUnmarshaller 
    {
        /// <summary>
        ...
        {
            UnlinkDeveloperIdentityResponse response = new UnlinkDeveloperIdentityResponse();
