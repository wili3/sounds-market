...
{
    /// <summary>
    /// Response Unmarshaller for SetIdentityPoolRoles operation
    /// </summary>  
    public class SetIdentityPoolRolesResponseUnmarshaller : JsonResponseUnmarshaller, ISimplifiedErrorUnmarshaller 
    {
        /// <summary>
        ...
        {
            SetIdentityPoolRolesResponse response = new SetIdentityPoolRolesResponse();
        ...
        {
            if (!string.IsNullOrEmpty(errorResponse.Code) && errorResponse.Code.StartsWith("ConcurrentModificationException", StringComparison.OrdinalIgnoreCase))
            {
